...
func (u UserBody) Validate() error {
	return validation.ValidateStruct(&u,
		...
		validation.Field(&u.Phone, validation.Required.Error(locale.CommonKeyPhoneRequired)),
		validation.Field(&u.Password,validation.Required.Error(locale.CommonKeyPasswordIsRequired)),
...
func (u *UserBody) NewRaw() UserRaw {
	...
	return UserRaw{
		ID:           NewAppID(),
		Name:         u.Name,
		SearchString: format.NonAccentVietnamese(u.Name),
		Username 
		Password
		Active: ,
		Phone: ,
